<?php include("startsida.php"); ?>
	...
	<p class="aboutText">This website was created by Isak Engström, Kevin Evans, Simon Källberg and Vera Fristedt Andersson
	for a school projekt in a course called Electronic Publishing. Thus, a webpage that is not for commercial use.</p>
	...
	any difficulties. The website should thrive to be as userfriendly as possible so that anyone can use it and understand how it works.</p>
	<h2 class="aboutHeader">How to search</h2>
	<p class="aboutText">Choose either Parts or Sets from the tabs above the search box depending on what you are 
	looking for. Then enter part of a name or ID-number in order to get all Items containing the entered phrase. 
	Remember that if you enter more than one word in the searchbox the words have to follow the chronoligical order 
	of how the name/ID-number is written in the system. For example a part called "Arm holder brick 2 x 2 with hole"
